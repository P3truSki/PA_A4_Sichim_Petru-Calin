...
Homework - Generarea Labirintului: Ca sa vedem ca labirntul e rezolvabil, folosesc un BFS printr-un queue cu diferite pozitii de inceput. Am suprascris paintComponent(Graphics g) ca sa fac labirintul folosind Graphics2D, si prin BufferedImage salvez rezultatul ca si fisier png cu ImageIO.write(). Starea o salvez printr-un flux incarcat in fisiere bin dat cu ObjectInputStream si ObjectOutputStream (Prin interfata marcator Serializable)
